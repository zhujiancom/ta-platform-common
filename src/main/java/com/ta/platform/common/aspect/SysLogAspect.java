...
public class SysLogAspect {
    ...
    public Object log(ProceedingJoinPoint point) throws Throwable{
        ...
        createSysLog(point, result, costTime);
        return result;
    }

    private void createSysLog(ProceedingJoinPoint point, Object result, long costTime){
        try {
            ...
            if(result instanceof Result){
                logMsg = ((Result) result).getMessage();
            }
            ...
            if(sysLog != null){
                logModelBuilder.logMsg(StrUtil.isNotBlank(sysLog.value()) ? sysLog.value() : logMsg);
                logModelBuilder.logLevel(sysLog.logLevel());
                logModelBuilder.logType(sysLog.logType());
                logModelBuilder.operateType(sysLog.operateType());
            }
